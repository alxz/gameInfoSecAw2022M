...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2022 at 09:52 PM
...
ALTER TABLE `tabquestions`
  ADD PRIMARY KEY (`qId`),
  ADD KEY `question_topics` (`topicid`);
...
--
-- Indexes for table `topicslist`
--
ALTER TABLE `topicslist`
...
--
ALTER TABLE `tabanswers`
  MODIFY `ansId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT for table `tabquestions`
--
ALTER TABLE `tabquestions`
  MODIFY `qId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `tabusers`
--
ALTER TABLE `tabusers`
  MODIFY `uId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `topicslist`
--
ALTER TABLE `topicslist`
